              ...
              <h6>Your Package includes:</h6>
                <ul>
                  <li>24/7 Monitoring &amp; Support </li>
                            ...
                            <li>Unlimited Detections &amp; Takedowns</li>
                            <li>Custom Monthly Reports</li>
                </ul>
                <div class="totalbox">$500</div>
          </div>
        </div>
            ...
            $.ajax({
                ...
                success:function(res){
                    if(res == 'error'){
                        ...
                        window.location.href = 'https://www.trademarkexclusive.com/payment-success?k='+res;
                    }
                }
            })
        }
