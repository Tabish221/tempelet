        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <span class="heading fw-600 my-3">Please provide the ownership details affiliated with your trademark application.<span></span></span>
                    <?php //$leadkey = $_GET['leadkey']; ?>
                    <form class="pt-md-4" action="" method="post" class="step2_valdate" >
                        
                    <div class="form-check form-chk-ind-org">
                        <label>
                            <input type="radio" name="own_radio" checked="" value="individual" class="individual">
                            Individual
                        </label>
                        <label>
                            <input type="radio" name="own_radio" value="organization" class="organization">
                            Organization
                        </label>
                    </div>
                        
                        <!-- INDIVIDUAL OWNER -->
                    <div class="form-group ind_own_fld" style="">
                    ...
                    <div class="form-group ind_own_fld" style="">
                        ...
                        <input type="text" class="form-control" name="tm_indv_fname" placeholder="First Name" required="required">
                    </div>


                    <div class="form-group ind_own_fld" style="">
                        <label>* Last Name:</label>
                        <input type="text" class="form-control" name="tm_indv_lname" placeholder="Last Name" required="required">
                    </div>
                    ...
                    <div class="form-group ind_own_fld" style="">
                        <select name="tm_indv_country" class="form-control" required="required">
                    ...
                    <div class="form-group ind_own_fld" style="">
                        <label>* Address:</label>
                        <input type="text" class="form-control" name="tm_indv_address" placeholder="Address" required="required">
                    </div>

                    <div class="form-group ind_own_fld" style="">
                        <label>* City:</label>
                        <input type="text" class="form-control" name="tm_indv_city" placeholder="City" required="required">
                    </div>
                    ...
                    <div class="form-group ind_own_fld" style="">
                         <select name="tm_indv_state" class="form-control" required="required">
                    ...
                    <div class="form-group ind_own_fld" style="">
                        ...
                        <input type="text" class="form-control" name="tm_indv_zip" placeholder="12345" required="required">
                    </div>

                    <div class="form-group ind_own_fld" style="">
                        <label>*  Phone:</label>
                        <input type="number" class="form-control" name="tm_indv_phone1" placeholder="Phone" required="required">
                    </div>

                    <div class="form-group ind_own_fld" style="">
                        <label>*  Email:</label>
                        <input type="email" class="form-control" name="tm_indv_email1" placeholder="me@example.com" required="required">
                    </div>

 <!-- ORGANIZATION OWNER -->

                    <div class="form-check form-chk-ind-org org_own_fld" style="display: none;">
                        <h6>Formation</h6>
                        <label>
                            <input type="radio" name="own_formation" checked="" value="us based" class="organizationz">
                            US Based
                        </label>
                        <label>
                            <input type="radio" name="own_formation" value="non us based" class="organizationz">
                            Non US Based
                        </label>
                    </div>
                    <div class="form-group org_own_fld" style="display: none;">
                        <label>* Organization Name:</label>
                        <input type="text" class="form-control" name="tm_org_name" placeholder="Organization Name">
                    </div>
                    <div class="form-group org_own_fld" style="display: none;">
                    ...
                    <div class="form-group org_own_fld" style="display: none;">
                        <select name="tm_org_type" class="form-control">
                    ...
                    <div class="form-group org_own_fld ct_formation" style="display: none;">
                        <label>* Country of Formation:</label>
                    </div>

                    <div class="form-group org_own_fld ct_formation" style="display: none;">
                        <select name="tm_org_country" class="form-control">
                            <option value="">Choose Country of Citizenship</option>
                            <option value="USX">United States</option>
                            <option value="AFX">Afghanistan</option>
                            <option value="ALX">Albania</option>
                    ...
                    <div class="form-group org_own_fld st_formation" style="display: none;">
                        <label>* State of Formation:</label>
                    </div>

                    <div class="form-group org_own_fld st_formation" style="display: none;">
                        <select name="tm_org_state_formation" class="form-control">
                    ...
                    <div class="form-group org_own_fld" style="display: none;">
                        ...
                        <input type="text" class="form-control" name="tm_org_position" placeholder="CEO">
                    </div>

                    <div class="form-group org_own_fld" style="display: none;">
                        <label>* First Name:</label>
                        <input type="text" class="form-control" name="tm_org_fname" placeholder="First Name">
                    </div>

                    <div class="form-group org_own_fld" style="display: none;">
                        <label>* Last Name:</label>
                        <input type="text" class="form-control" name="tm_org_lname" placeholder="Last Name">
                    </div>
                    ...
                    <div class="form-group org_own_fld" style="display: none;">
                        <label>* Address:</label>
                        <input type="text" class="form-control" name="tm_org_address" placeholder="Address">
                    </div>

                    <div class="form-group org_own_fld" style="display: none;">
                        <label>* City:</label>
                        <input type="text" class="form-control" name="tm_org_city" placeholder="City">
                    </div>
                    ...
                    <div class="form-group org_own_fld" style="display: none;">
                         <select name="tm_org_state" class="form-control">
                            <option value="">Select State/Province/Region</option>
                            <option value="AL">Alabama</option>
                            <option value="AK">Alaska</option>
                            <option value="AZ">Arizona</option>
                    ...
                    <div class="form-group org_own_fld" style="display: none;">
                        <label>*  Zip/Postal Code:</label>
                        <input type="text" class="form-control" name="tm_org_zip" placeholder="12345">
                    </div>

                    <div class="form-group org_own_fld" style="display: none;">
                        <label>*  Phone:</label>
                        <input type="text" class="form-control" name="tm_org_phone" placeholder="Phone">
                    </div>

                    <div class="form-group org_own_fld" style="display: none;">
                        <label>*  Email:</label>
                        <input type="email" class="form-control" name="tm_org_email" placeholder="me@example.com">
                    </div>

                    <div class="clone_fileds" style="display:none">

                    </div>
                        
                        <div class="submits-wrapper d-md-flex justify-content-between align-items-center mt-3">
                            <p>
