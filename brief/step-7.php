...
.order-details-box li strong{font-weight:600}
.checkout{width:410px;margin:0 auto 30px;padding:15px;background:#f3f6fa;border:1px solid;border-color:#c2cadb #bbc5d6 #b7c0cd;border-radius:7px;-webkit-box-shadow:0 1px 5px rgba(0,0,0,0.15);box-shadow:0 1px 5px rgba(0,0,0,0.15)}
.checkout > p{zoom:1}
...
<div class="header-wrap">
  <header>
    <div class="container clearfix">
      <div class="row">
        <div class="col-xs-12 col-sm-12 text-center"> <a href="javascript:;" class="logo" title=""><img src="assets/images/logo.svg" style=" width: 225px; "></a> </div>
...
$fullamount = ((int)$exp_term_fee + (int)$uspto_fee + (int)$price);
        ...
        <div class="col-lg-5" >
          <div class="order-details-box">
              ...
              <h6>Your Package includes:</h6>
                <ul>
                  <li><?php echo getpageSource('tm_type_search');?> <strong><?php echo '$'.getpageSource('uspto_fee');?></strong> </li>
                            <li><?php echo getpageSource('data_pkg_title');?> <strong><?php echo '$'.getpageSource('data_pkg_price');?></strong> </li>
                            <?php if(getpageSource('exp_term_fee') > 0){ ?>
                                <li>24-hour Expedited Processing (Next Business Day):  <strong><?php echo '$'.getpageSource('exp_term_fee');?></strong></li>
                            <?php } ?>
                </ul>
                <div class="totalbox">$ <?php echo $fullamount;?></div>
          </div>
      </div>
      </div>
  </div>
            ...
            $.ajax({
                ...
                success:function(res){
                    if(res == 'error'){
                        ...
                        window.location.href = 'https://www.<?= $url;?>/payment-success?k='+res;
                    }
                }
            })
        }
